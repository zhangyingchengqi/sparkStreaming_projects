...
import project2_wordcounts.streamingWC.dao.KafkaCluster.LeaderOffset
...
class KafkaManager(val kafkaParams: Map[String, String]) extends Serializable {
  ...
  def createDirectStream[K: ClassTag, V: ClassTag, KD <: Decoder[K]: ClassTag, VD <: Decoder[V]: ClassTag](
                                                                                                            ssc: StreamingContext, kafkaParams: Map[String, String], topics: Set[String]): InputDStream[ConsumerRecord[String,String]] = {
